...
//  BankeyUnitTests
//
//  Created by saul corona on 19/06/22.
//
...
class AccountSummaryViewControllerTests: XCTestCase {
    ...
    func testTitleAndMessageForServerError() throws {
        let titleAndMessage = vc.titleMessageForTesting(for: .serverError)
    ...
    func testTitleAndMessageForNetworkError() throws {
        let titleAndMessage = vc.titleMessageForTesting(for: .decodingError)
